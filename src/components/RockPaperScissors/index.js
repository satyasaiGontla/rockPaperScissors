...
class RockPaperScissors extends Component {
  ...
  onClickChoice = id => {
    ...
    let resultStatus = ''
    if (id === 'ROCK' && computerChoice === 'ROCK') {
      resultStatus = 'IT IS DRAW'
    } else if (id === 'ROCK' && computerChoice === 'PAPER') {
      resultStatus = 'YOU LOSE'
      this.decreaseScore()
    } else if (id === 'ROCK' && computerChoice === 'SCISSORS') {
      resultStatus = 'YOU WON'
      this.increaseScore()
    } else if (id === 'PAPER' && computerChoice === 'PAPER') {
      resultStatus = 'IT IS DRAW'
    } else if (id === 'PAPER' && computerChoice === 'ROCK') {
      resultStatus = 'YOU WON'
      this.increaseScore()
    } else if (id === 'PAPER' && computerChoice === 'SCISSORS') {
      resultStatus = 'YOU LOSE'
      this.decreaseScore()
    } else if (id === 'SCISSORS' && computerChoice === 'SCISSORS') {
      resultStatus = 'IT IS DRAW'
    } else if (id === 'SCISSORS' && computerChoice === 'ROCK') {
      resultStatus = 'YOU LOSE'
      this.decreaseScore()
    } else {
      resultStatus = 'YOU WON'
